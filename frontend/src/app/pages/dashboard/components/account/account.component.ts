...
export class AccountComponent {
  info = [
    ...
    {id: 4, title: "Total Saving", description: "#25,900", src: "assets/003-saving.svg", svgBgColor: "rgba(232, 243, 218, 1)", hoverBorderColor: "rgba(124, 187, 76, 1)", hoverShadowColor: "rgba(232, 243, 218, 1)"},
  ]
}
